...
# Important
- **This package is a fork of [fhir_at_rest](https://pub.dev/packages/fhir_at_rest) that I plan to continue to maintain. Thanks to [fhirfli.dev](https://fhirfli.dev) and all the contributors, for their work on this package.**
