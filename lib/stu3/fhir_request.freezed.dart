...
mixin _$FhirRequest {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Uri base, Stu3ResourceType type, FhirId fhirId, bool pretty, Summary summary, String format, List<String> elements, List<String> parameters, int? count, FhirInstant? since, FhirDateTime? at, String? reference, MimeType? mimeType, String accept, Client? client) history,
    required TResult Function(Uri base, Stu3ResourceType type, bool pretty, Summary summary, String format, List<String> elements, List<String> parameters, int? count, FhirInstant? since, FhirDateTime? at, String? reference, MimeType? mimeType, String accept, Client? client) historyType,
    ...
    required TResult Function(Uri base, Stu3ResourceType? type, FhirId? fhirId, bool pretty, Summary summary, String format, List<String> elements, List<String> parameters, Parameters? fhirParameter, String operation, bool usePost, bool useFormData, MimeType? mimeType, String accept, Client? client) operation,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(Uri base, Stu3ResourceType type, FhirId fhirId, bool pretty, Summary summary, String format, List<String> elements, List<String> parameters, int? count, FhirInstant? since, FhirDateTime? at, String? reference, MimeType? mimeType, String accept, Client? client)? history,
    TResult? Function(Uri base, Stu3ResourceType type, bool pretty, Summary summary, String format, List<String> elements, List<String> parameters, int? count, FhirInstant? since, FhirDateTime? at, String? reference, MimeType? mimeType, String accept, Client? client)? historyType,
    ...
    TResult? Function(Uri base, Stu3ResourceType? type, FhirId? fhirId, bool pretty, Summary summary, String format, List<String> elements, List<String> parameters, Parameters? fhirParameter, String operation, bool usePost, bool useFormData, MimeType? mimeType, String accept, Client? client)? operation,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
